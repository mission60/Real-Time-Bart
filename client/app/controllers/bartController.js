                ...
                var dot = g.selectAll('image')
                          ...
                          .on('mouseover', function(d) {
                            ...
                            tip.transition()
                                .duration(200)
                                .style('opacity', 0.9)
                            tip.html("<p style='font-size:16px'> Next train coming in: " + timeForNextTrain + ' min. Train is in between ' + station1 + ' and ' + station2 + ' and is ' + (routeInfo[rte[bestStationIdx+1]][dest][0]) + ' min away to ' + rte[bestStationIdx+1] + "</p>")
